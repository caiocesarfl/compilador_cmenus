...
var_declaracao
    ...
    |   tipo_especificador ident ('[' num_int ']')+ ';'
    ;
...
tipo_especificador
    ...
    |   'char'
    |   'void'
    |   'struct' ident '{' atributos_declaracao '}'
    ;
...
fun_declaracao returns [Scope scope]
...
composto_decl
    :   '{' local_declaracoes comando_lista '}'
    ;
...
expressao_simples
    :   expressao_soma op_relacional expressao_soma
    |   expressao_soma
    ;
...
ident
    :   LETRA_MINUSCULA (LETRA_MINUSCULA | LETRA_MAIUSCULA | DIGIT )*
    ;
